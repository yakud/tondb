...
CH_ADDR=http://default:V9AQZJFNX4ygj2vP@192.168.100.3:8123/ton2?max_query_size=3145728000 nohup /tmp/blocks-stream-receiver >> /data/ton/log/stream-receiver.log &
